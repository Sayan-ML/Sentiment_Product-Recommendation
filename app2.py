...
# ========== CLASS WITHOUT "pickle/" ==========
class SentimentRecommenderModel:
    MODEL_NAME = r'C:\Users\sayan\OneDrive\Desktop\Amazon, Sentiment analysis + Recommendation system\stacking_model.pkl'
    VECTORIZER = r'C:\Users\sayan\OneDrive\Desktop\Amazon, Sentiment analysis + Recommendation system\tfidf-vectorizer.pkl'
    RECOMMENDER = r'C:\Users\sayan\OneDrive\Desktop\Amazon, Sentiment analysis + Recommendation system\user_final_rating.pkl'
    CLEANED_DATA = r'C:\Users\sayan\OneDrive\Desktop\Amazon, Sentiment analysis + Recommendation system\cleaned_data.pkl'

    def __init__(self):
        self.model = pickle.load(open(self.MODEL_NAME, 'rb'))
        self.vectorizer = pd.read_pickle(self.VECTORIZER)
        self.user_final_rating = pickle.load(open(self.RECOMMENDER, 'rb'))
